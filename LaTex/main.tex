...
\begin{table}[H]
    \footnotesize 
    \centering
    \caption{Performance Comparison on Synthetic Datasets (Insertion/Search times in nanoseconds)}
    ...
    \begin{tabularx}{\columnwidth}{|l|c|c|c|c|c|}
        ...
        \hline
        1K & 82000/5000 & \textbf{163000/1000} & 165000/2000 & 227000/13000 & 148000/11000 \\
        10K & \textbf{750000}/63000 & 1811000/\textbf{1000} & 1820000/11000 & 2270000/88000 & 2348000/74000 \\
        100K & \textbf{6782000}/542000 & 19542000/\textbf{31000} & 19680000/98000 & 28430000/980000 & 30286000/917000 \\
        1M & \textbf{66646000}/7045000 & 173945000/\textbf{187000} & 174220000/445000 & 477827000/20957000 & 365093000/15751000 \\
        50M & \textbf{5752689000}/520698000 & 42529801000/\textbf{17987000} & 42847132000/89441000 & 82092444000/2603842000 & 72793606000/1759648000 \\
        \hline
    \end{tabularx}
    \vspace{0.2cm}
    \begin{minipage}{\columnwidth}
    \footnotesize
    \textit{Format: Insertion time / Search time in nanoseconds (ns). Bold indicates best performance in category.}
    \end{minipage}
\end{table}
...
\begin{itemize}
    ...
    \item \textbf{Search Supremacy:} Hash Search dominates search performance, achieving remarkable scalability with only 17,987,000ns search time for 50 million images.
...
\begin{table}[H]
    ...
    \begin{tabularx}{\columnwidth}{|l|l|c|c|}
        \hline
        \textbf{Data Structure} & \textbf{Dataset Size} & \textbf{Insertion (ns)} & \textbf{Search (ns)} \\ 
        \hline
        Linear Search & 5K images & 375000 & 31500 \\
        Linear Search & 25K images & 1875000 & 157500 \\
        Hash Search & 5K images & 902500 & 500 \\
        Hash Search & 25K images & 4512500 & 2500 \\
        Hash Dynamic & 5K images & 910000 & 5500 \\
        Hash Dynamic & 25K images & 4550000 & 27500 \\
        Octree Search & 5K images & 1137500 & 44000 \\
        Octree Search & 25K images & 5687500 & 220000 \\
        Quadtree Search & 5K images & 1175000 & 37000 \\
        Quadtree Search & 25K images & 5875000 & 185000 \\
        \hline
    \end{tabularx}
    \vspace{0.2cm}
    \begin{minipage}{\columnwidth}
    \footnotesize
    \textit{Note: Execution times measured in nanoseconds (ns) on standardized hardware; \\actual performance depends on specific implementation and system architecture.}
    \end{minipage}
\end{table}
