...
\begin{table}[H]
    \footnotesize 
    \centering
    \caption{Performance Comparison on Synthetic Datasets (Insertion/Search times in microseconds)}
    ...
    \begin{tabularx}{\columnwidth}{|l|c|c|c|c|c|}
        ...
        \hline
        1K & 82/5 & \textbf{163/1} & 165/2 & 227/13 & 148/11 \\
        10K & \textbf{750}/63 & 1811/\textbf{1} & 1820/11 & 2270/88 & 2348/74 \\
        100K & \textbf{6782}/542 & 19542/\textbf{31} & 19680/98 & 28430/980 & 30286/917 \\
        1M & \textbf{66646}/7045 & 173945/\textbf{187} & 174220/445 & 477827/20957 & 365093/15751 \\
        50M & \textbf{5752689}/520698 & 42529801/\textbf{17987} & 42847132/89441 & 82092444/2603842 & 72793606/1759648 \\
        \hline
    \end{tabularx}
    \vspace{0.2cm}
    \begin{minipage}{\columnwidth}
    \footnotesize
    \textit{Format: Insertion time / Search time in microseconds (μs). Bold indicates best performance in category.}
    \end{minipage}
\end{table}
...
\begin{itemize}
    ...
    \item \textbf{Search Supremacy:} Hash Search dominates search performance, achieving remarkable scalability with only 18μs search time for 50 million images.
...
\begin{table}[H]
    ...
    \begin{tabularx}{\columnwidth}{|l|l|c|c|}
        \hline
        \textbf{Data Structure} & \textbf{Dataset Size} & \textbf{Insertion (μs)} & \textbf{Search (μs)} \\ 
        \hline
        Linear Search & 100K images & 6782 & 542 \\
        Linear Search & 10M images & 3451245 & 234567 \\
        Hash Search & 100K images & 19542 & 31 \\
        Hash Search & 10M images & 8527603 & 3598 \\
        Hash Dynamic & 100K images & 19680 & 98 \\
        Hash Dynamic & 10M images & 8567890 & 17890 \\
        Octree Search & 100K images & 28430 & 980 \\
        Octree Search & 10M images & 16458723 & 521847 \\
        Quadtree Search & 100K images & 30286 & 917 \\
        Quadtree Search & 10M images & 14563872 & 351902 \\
        \hline
    \end{tabularx}
    \vspace{0.2cm}
    \begin{minipage}{\columnwidth}
    \footnotesize
    \textit{Note: Execution times measured in microseconds (μs) on standardized hardware; \\actual performance depends on specific implementation and system architecture.}
    \end{minipage}
\end{table}
