...
\begin{table}[H]
    \footnotesize 
    \centering
    % Legenda atualizada para milissegundos
    ...
    \begin{tabular}{ll rrrrr} 
        ...
        \midrule
        % --- Valores abaixo estão TODOS convertidos para ms e arredondados ---
...
\begin{table}[H]
    ...
    % MUDANÇA PRINCIPAL: l para a primeira coluna, e X centralizado para as outras
