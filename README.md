...
g++ -O2 -o paa_trabalho1 src/PAA_Trabalho1.cpp && ./paa_trabalho1

# Scalable benchmark (WARNING: Takes 30+ minutes for full 50M scale)
g++ -O2 -o scalable src/benchmarks/scalable_benchmark.cpp && ./scalable

# Real image benchmark (NEW)
g++ -O2 -std=c++17 -o img_benchmark src/benchmarks/benchmark_imagens_simples.cpp && ./img_benchmark

# Recursion vs iteration comparison
g++ -O2 -o rec_iter src/benchmarks/benchmark_recursivo_vs_iterativo.cpp && ./rec_iter
```
...
*Generated by PAA Assignment 1 - PUC Minas - August 2025*
